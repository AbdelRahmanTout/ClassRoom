...
CREATE TABLE `faculty` (
  ...
  UNIQUE KEY `faculty_branch_name_UNIQUE` (`nameFaculty`)
...
INSERT INTO `faculty` VALUES (1,'Faculty of Arts'),(2,'Faculty of Engineering'),(3,'Faculty of Health'),(8,'Faculty of Media'),(4,'Faculty of Science');
