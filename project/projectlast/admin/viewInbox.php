						...
						while($line = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
							echo'
								<tr>
									...
									<td><a href="viewInbox.php?explore=true&typeMessage='.$line['typeMessage'].'&descriptionMessage='.$line['descriptionMessage'].'&receiveDate='.$line['receiveDate'].'&idUser='.$line['idUser'].'"><img src="../style/view.ico"></a></td>
									<td><a href="viewInbox.php?delete=true&explore=false&idMessage='.$line['idMessage'].'"><img src="../style/delete.ico"></a></td>
								</tr>
							';
						}
						echo'</table>';
