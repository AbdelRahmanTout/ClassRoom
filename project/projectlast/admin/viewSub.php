								...
								<tr>
									...
									<th>
										<form action="" method="post">
											...
											<button style="border:none;border-style:transparent;background:#3B3B3B" type="submit">
									...
									<tr>
										...
										<td> 
											<form action="viewSub.php" method="post">
												...
												<button style="border:none;border-style:transparent;" type="submit">
													<img src="../style/edit.ico">
												</button>
											</form>
										</td>
										<td><a href="viewSub.php?deleteSubject=true&idSubject='.$line['idSubject'].'"><img src="../style/delete.ico"></a></td>
										<td></td>
									</tr>
								';
							}
