			...
			<div id="site_content">
				...
				<div id="content">
					...
					<?php
						...
						$result = mysqli_query($con, $query);
						echo'
							<table style="width:120%; border-spacing:0;table-layout:auto">
							<tr>
								<th>ID</th>
								<th>Full Name</th>
								<th>Phone Nb.</th>
							...
							if(isset($_POST['search'])) {
								if($line['idUser'] == $_POST['searchId']) {
									echo'
										<tr>
											...
											<td>'.$line['function'].'</td>
											<td>'.$line['email'].'</td>
											<td><a href="viewUser.php?update=true&idUser='.$line['idUser'].'&fullName='.$line['fullName'].'&phone='.$line['phone'].'&idFaculty='.$line['idFaculty'].'&function='.$line['function'].'&email='.$line['email'].'"><img src="../style/edit.ico"></a></td>
											<td><a href="viewUser.php?delete=true&idUser='.$line['idUser'].'"><img src="../style/delete.ico"></a></td>
										</tr>
									';
								}
							}
								...
								echo'
									<tr>
										...
										<td>'.$line['email'].'</td>
										<td><a href="viewUser.php?update=true&idUser='.$line['idUser'].'&fullName='.$line['fullName'].'&phone='.$line['phone'].'&idFaculty='.$line['idFaculty'].'&function='.$line['function'].'&email='.$line['email'].'"><img src="../style/edit.ico"></a></td>
										<td><a href="viewUser.php?delete=true&idUser='.$line['idUser'].'&function='.$line['function'].'"><img src="../style/delete.ico"></a></td>
									</tr>
								';
							}
						}
